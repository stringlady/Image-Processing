...
/**
 * A test class for the green grayscale command.
 */
public class GreenGrayscaleTest extends AbstractCommandTest {
  ICommand cmd;
  IImage guitarImage;
  IImage sample4by4;
  IImage sample3by4;
